                ...
                <div class="p-6 text-black dark:text-black">
                    ...
                    <x-table>
                        ...
                        @foreach ($fuzzy_inputs as $fuzzy_input)
                            <tr>
                                <td>{{ $num++ }} </td>
                                <td>{{ $fuzzy_input->symptom ? $fuzzy_input->symptom->nama : 'Gejala tidak ditemukan' }}
                                </td>
                                <td>{{ $fuzzy_input->himpunan }}</td>
                                <td>
                                    @if ($fuzzy_input->himpunan == 'Ringan')
                                        ≤ {{ $fuzzy_input->min }} {{ $fuzzy_input->unit }}
                                    @elseif ($fuzzy_input->himpunan == 'Berat')
                                        ≥ {{ $fuzzy_input->max }} {{ $fuzzy_input->unit }}
                                    @else
