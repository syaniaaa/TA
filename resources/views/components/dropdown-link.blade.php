<a
    {{ $attributes->merge(['class' => 'block w-full px-6 py-2 text-start text-sm leading-5 text-gray-500 dark:text-gray-500  dark:hover:bg-gray-800 focus:outline-none focus:bg-gray-100 dark:focus:bg-gray-800 transition duration-150 ease-in-out']) }}>{{ $slot }}</a>
